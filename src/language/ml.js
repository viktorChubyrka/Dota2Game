...
export default new MLCreate({
  ...
  languages: [
    new MLanguage("english").create({
      ...
      rule11:"1.Darewin’s Club является клубом закрытого типа, для вступления в который нужно пройти обязательную регистрацию и идентификацию личности. Требования по идентификации могут быть расширены согласно нормам и правилам политики AML и FFT.",
      rule21:"2. Для регистрации необходимо указать действующий email и подтвердить его действительность. Email, так же как и уникальный ник, остается неизменным и закрепляется за пользователем клуба на постоянной основе.",
      rule31:"3. Клуб оставляет за собой право вносить поправки и изменения в правила клуба. О таких изменениях члены клуба будут уведомлены в электронной почте.",
      rule41:"4. Клуб имеет полное право и полномочия в вопросе принятия/исключения/временного ограничения доступа члену(-ам) клуба. Решение рассматривается в индивидуальном порядке и принимается администрацией клуба.",
      rule51:"5. Все члены клуба обязаны соблюдать правила клуба Darewin’s Club. Несоблюдение правил влечет за собой штрафные санкции такие как: материальное наказание, временное ограничение доступа, исключение без права на помилование.",
      rule61:"6. Только администрация клуба имеет право на окончательное решение в споре между членами клуба либо при вынесении вердиктов, касающихся результатов матчей, поведения пользователей, случаев мошенничества и т.п. вопросов.",
      rule71:"7. Любой член клуба имеет право обратиться к администрации клуба напрямую для решения его вопроса.",
      rule81:"8. Если вопросы/конфликты/спорные моменты не решены между членами клуба самостоятельно, каждая из сторон вопроса/конфликта/спорного момента имеет полное право обратиться к администрации для помощи в разрешении вопроса/конфликта/спорного момента. В таком случае администрация берет на себя полную ответственность в вынесении вердикта. Срок вынесения вердикта не должен превышать 48 часов с момента обращения по конкретному случаю. В редких случаях администрации потребуется больше времени для вынесения решения, о чем будут уведомлены стороны вопроса/конфликта/спорного момента.",
      rule91:"9. Все клубные игры находятся в альфа-тестировании, что означает клуб Darewin’s Club на раннем этапе развития предоставляет своим пользователям проводить состязания только по дисциплине Dota2 в рамках конкретных правил проведения матчей в Darewin’s Club.",
      rule12:"10. В Darewin’s Club запрещена реклама любого формата, за исключением тех случаев, когда это оговорено с администрацией.",
      rule22:"11. В Darewin’s Club нет четких правил поведения и рамок приличия, однако каждый член клуба должен уважать остальных участников клуба, относиться к ним с должным уровнем приличия и взаимопонимания.",
      rule32:"12. Если слова/действия одного участника Darewin’s Club задевают или унижают чувства, мысли и т.д. другого участника, то конфликтная ситуация должна быть решена между участниками клуба. В случае невозможности данного действия потерпевшая сторона имеет полное право обратиться к администрации со своей жалобой. При развитии такого сценария меры наказания могут варьироваться от публичного извинения и вплоть до материального взыскания. Крайними мерами будет исключение из клуба с полным лишением средств и права на амнистию.",
      rule42:"13. В общем чате Darewin’s Club запрещены флуд, спам, кибербулинг, линки на непроверенные источники, нецензурная лексика, публикация заведомо ложных сведений/информации, вымогательство и т.п. действия. В случае нарушения данного правила член клуба может получить временный бан.",
      rule13:"14. Все игры проходят по правилу Bo1, Captains mode, team balance/shuffle players.",
      rule23:"15. Недоукомплектованные команды (не полный состав 5 человек) участвуют в играх формата Solo.",
      rule33:"16. Таймер лобби игры на сайте – 10 минут. Если в течение 10 минут лобби на сайте не будет укомплектовано – оно автоматически разрушается, взносы возвращаются участникам.",
      rule43:"17. Таймер лобби в самой игре – 5 минут.",
      rule53:"18. Если пользователь покинул лобби на сайте, в котором уже зарегистрирован, он получает штраф в размере 50% от взноса.",
      rule63:"19. Если пользователь не подключился к лобби в игре, в котором уже зарегистрирован, он получает штраф в размере 100% от взноса. Игра аннулируется. Выплачивается компенсация остальным игрокам.",
      rule73:"20. Капитан может определяться несколькими путями: по добровольному желанию и согласию игроков в команде, через команду –roll (игрок с наибольшим значением становится капитаном) либо игрок с наивысшим показателем рейтинга.",
      rule83:"21. Если игрок одной из команд покинет игру (Leave), то игра продолжается. Если победит команда, у которой 5 человек, то они получат стандартный призовой фонд. Если победит команда в меньшинстве, то они получат увеличенный призовой фонд.",
      rule93:"22. Если игрок в процессе игры будет наносить вред игровому процессу, использовать читы, находиться афк, разбивать предметы и всячески влиять на игру в интересах поражения своей команды, то по результатам игры, игрок может потерять игровой взнос, а результаты игры аннулируются.",
      rule103:"23. У каждой команды есть по 3 паузы, общей продолжительностью в 7 минут. Если игрок не вернулся в игру по истечению 7 минут, то у него остается 5 минут внутри игрового времени (стандартное время, продиктованное условиями Valve). Если игрок не возвращается по истечению следующих 5 минут после паузы, то ему присуждается техническое поражение.",
      rule113:"24. Продолжительность пауз должна засекаться подручными средствами капитанов обеих команд. При обжаловании преждевременного отжима паузы будет учитываться погрешность в 10 секунд. ",
      rule123:"25. При злоупотреблении пауз в важный момент (смок, предстоящий килл, после убийства врага и других важных ситуациях) либо прожимание/отжимание пауз без готовности противника, игроку, нарушившему правило, присуждается техническое поражение при возникновении такого инцидента.",
      rule133:"26. Победа присуждается команде, которая уничтожила главное строение (Трон) противника.",
      rule14:"27. Все игры проходят по правилу Bo1, Captains mode.",
      rule24:"28. Полностью укомплектованные команды (полный состав 5 человек) участвуют в играх формата Party.",
      rule34:"29. Таймер лобби игры на сайте – 10 минут. Если в течение 10 минут лобби на сайте не будет укомплектовано – оно автоматически разрушается, взносы возвращаются участникам.",
      rule44:"30. Таймер лобби в самой игре – 5 минут.",
      rule54:"31. Если пользователь команды покинул лобби на сайте, в котором уже зарегистрирован, вся команда покидает лобби и получает штраф в размере 50% от взноса. ",
      rule64:"32. Если пользователь не подключился к лобби в игре, в котором уже зарегистрирован, вся команда получает штраф в размере 100% от взноса. Игра аннулируется. Выплачивается компенсация другой команде.",
      rule74:"33. Если игрок одной из команд покинет игру (Leave), то игра продолжается. ",
      rule84:"34. Если игрок одной из команд в процессе игры будет наносить вред игровому процессу, использовать читы и манипуляции со сторонним софтом, которые дают преимущество своей команде, то по результатам игры, вся его команда теряет игровой взнос, а результаты игры аннулируются.",
      rule94:"35. У каждой команды есть по 3 паузы, общей продолжительностью в 7 минут. Если игрок не вернулся в игру по истечению 7 минут, то у него остается 5 минут внутри игрового времени (стандартное время, продиктованное условиями Valve). Если игрок не возвращается по истечению следующих 5 минут после паузы, то ему присуждается техническое поражение.",
      rule104:"36. Продолжительность пауз должна засекаться подручными средствами капитанов обеих команд. При обжаловании преждевременного отжима паузы будет учитываться погрешность в 10 секунд. ",
      rule114:"37. При злоупотреблении пауз в важный момент (смок, предстоящий килл, после убийства врага и других важных ситуациях) либо прожимание/отжимание пауз без готовности противника, команде игрока, который нарушил это правило, присуждается техническое поражение при возникновении такого инцидента.",
      rule124:"38. Победа присуждается команде, которая уничтожила главное строение (Трон) противника."
    }),
    ...
    new MLanguage("russian").create({
      ...
      rule74:"33. Если игрок одной из команд покинет игру (Leave), то игра продолжается. ",
      rule84:"34. Если игрок одной из команд в процессе игры будет наносить вред игровому процессу, использовать читы и манипуляции со сторонним софтом, которые дают преимущество своей команде, то по результатам игры, вся его команда теряет игровой взнос, а результаты игры аннулируются.",
      rule94:"23. У каждой команды есть по 3 паузы, общей продолжительностью в 7 минут. Если игрок не вернулся в игру по истечению 7 минут, то у него остается 5 минут внутри игрового времени (стандартное время, продиктованное условиями Valve). Если игрок не возвращается по истечению следующих 5 минут после паузы, то ему присуждается техническое поражение.",
      rule104:"24. Продолжительность пауз должна засекаться подручными средствами капитанов обеих команд. При обжаловании преждевременного отжима паузы будет учитываться погрешность в 10 секунд. ",
      rule114:"25. При злоупотреблении пауз в важный момент (смок, предстоящий килл, после убийства врага и других важных ситуациях) либо прожимание/отжимание пауз без готовности противника, команде игрока, который нарушил это правило, присуждается техническое поражение при возникновении такого инцидента.",
      rule124:"26. Победа присуждается команде, которая уничтожила главное строение (Трон) противника."
    }),
  ],
});
